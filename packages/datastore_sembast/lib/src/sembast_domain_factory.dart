...
import 'sembast/unit_of_work/sembast_unit_of_work.dart';
...
/// Factory for creating a [LibraryDomain] instance backed by Sembast.
///
/// Add `datastore_sembast` to your `pubspec.yaml` dependencies alongside
/// `library_scanner_core`. No other datastore package is required.
///
/// ```dart
/// final domain = SembastDomainFactory.create(unitOfWork: myUnitOfWork);
/// ```
class SembastDomainFactory {
